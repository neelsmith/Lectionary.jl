@testset "Test URN conversions with reading functions" begin
    ...
    @test reading1(epiph, urns = true) == [[expectedurn1]]
    ...
    @test reading2(epiph, urns = true) == [[expectedurn2]]
    ...
    @test gospel(epiph, urns = true) == [[expectedgospelurn]]
    ...
    @test psalm(epiph, urns = true) == [expectedpsalmurns]
