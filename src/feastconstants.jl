...
# Principal feasts
const FAST_ASH_WEDNESDAY = 0
const HOLY_WEEK_MONDAY = -1
const HOLY_WEEK_TUESDAY = -2
const HOLY_WEEK_WEDNESDAY = -3
...
const MOVABLE = [
    ...
    FEAST_TRINITY,  FAST_ASH_WEDNESDAY, 
...
const YEAR1_FEASTS = [
    FEAST_SAINT_THOMAS,
    FEAST_CHRISTMAS, FEAST_SAINT_STEPHEN, FEAST_SAINT_JOHN, FEAST_HOLY_INNOCENTS
]
